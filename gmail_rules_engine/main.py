...
from gmail_rules_engine.utils.helpers import (
    setup_logging, load_env_file, get_db_connection_string,
...
def main():
    ...
    parser.add_argument(
        ...
        type=int, 
        default=5,
        help="Interval in minutes to run the job"
    )
    parser.add_argument(
        "--log-level", 
        default="INFO",
    ...
    # Run job
    if args.run_once:
        run_job(email_fetcher, db_manager, rule_engine, action_handler, args.max_results)
    else:
